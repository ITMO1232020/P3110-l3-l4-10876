...
public class Medic extends Person implements PatientPickUp, PatientCondition, PatientCure{
    ...
    @Override
    public String cure(Patient patient, String illness) throws IllnessEqualsNullException{
        if (illness == null) throw new IllnessEqualsNullException("Error. Illness cannot be set to null.");
    ...
    public String allAttentionOnPatient(Patient patient){
        return (getName() + " is busy taking care only of " + patient.getName() + ".");
    }

    public String bring (Patient patient, String thing){
        return (getName() + " brought " + thing + " to " + patient.getName() + ".");
    }

    public String forceTo (Patient patient, Place place) {
        patient.setPlace(Place.BED);
        return (patient.getName() + " is forcefully put in " + place + ".");
    }
